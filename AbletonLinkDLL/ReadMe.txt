========================================================================
    DYNAMIC LINK LIBRARY: AbletonLinkDLL-Projektübersicht
========================================================================

Diese AbletonLinkDLL-DLL wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre AbletonLinkDLL-Anwendung besteht.


AbletonLinkDLL.vcxproj
...
AbletonLinkDLL.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen AbletonLinkDLL.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
